...
<head>
    ...
    <link rel="stylesheet" href="./frontend/mobil-styles.css" media="screen and (min-width: 360px)">
    <link rel="stylesheet" href="./frontend/tablet-styles.css" media="screen and (min-width: 768px)">
    <link rel="stylesheet" href="./frontend/desktop-styles.css" media="screen and (min-width: 1300px)">
</head>
<body>
